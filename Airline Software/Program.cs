...
class Program
{
    ...
    /// <summary>
    /// This function handles the menu options and functionality for the Accountant. 
    /// The options available to the Accountant are to calculate the percent capacity of a 
    /// specific flight, calculate the income generated by a flight, calculate the total 
    /// income generated by all flights, calculate the number of flights scheduled within 
    /// a time range, change their password, or log out of the system. 
    /// 
    /// The function displays a menu of options and prompts the user for their choice. Depending 
    /// on the choice made by the user, the function calls appropriate methods to execute the 
    /// required functionality. 
    /// 
    /// If the user chooses to calculate the percent capacity of a specific flight, the function 
    /// prompts the user to enter the flight number, displays the flight information, and then 
    /// calculates and displays the percent capacity of the flight. 
    /// 
    /// If the user chooses to calculate the income generated by a flight, the function prompts 
    /// the user to enter the flight number, displays the flight information, and then calculates 
    /// and displays the income generated by the flight. 
    /// 
    /// If the user chooses to calculate the total income generated by all flights, the function 
    /// calculates and displays the total income generated by all flights in the system. 
    /// 
    /// If the user chooses to calculate the number of flights scheduled within a time range, the 
    /// function prompts the user to enter the time range (day, month, week, or year), calculates 
    /// the number of flights scheduled within that time range, and displays the result. 
    /// 
    /// If the user chooses to change their password, the function prompts the user to enter a new 
    /// password and updates the user's password in the system. 
    /// 
    /// If the user chooses to log out, the function logs the user out of the system and returns 
    /// control to the calling function. 
    /// 
    /// If any errors occur during the execution of the function, appropriate error messages are 
    ...
    /// <summary>
    /// This function handles the menu options and functionality for the Marketing Manager. 
    /// The options available to the Marketing Manager are to assign a plane for a specific flight, 
    /// assign a plane for all flights, change their password, or log out of the system. 
    /// 
    /// The function displays a menu of options and prompts the user for their choice. Depending on 
    /// the choice made by the user, the function calls appropriate methods to execute the required 
    /// functionality. 
    /// 
    /// If the user chooses to assign a plane for a specific flight, the function prompts the user 
    /// to enter the flight number, displays a list of flights with no assigned planes, and then 
    /// assigns a plane for the selected flight. 
    /// 
    /// If the user chooses to assign a plane for all flights, the function calls a method to assign 
    /// a plane for all flights in the system. 
    /// 
    /// If the user chooses to change their password, the function prompts the user to enter a new 
    /// password and updates the user's password in the system. 
    /// 
